...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      auth_desc: 'Please enter your 6-digit security PIN to access the inventory dashboard.',
      ...
      footer_address: 'Near Transformer Chauraha, Harhwa Fatak Road ,Gorakhpur, Uttar Pradesh, India',
